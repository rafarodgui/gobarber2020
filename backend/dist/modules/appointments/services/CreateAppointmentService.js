                ...
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        if (findAppointmentsInSameDate) {
                            throw new AppError_1.default('This date is occuped', 401);
                        }
                        if (date_fns_1.isBefore(date_fns_1.startOfHour(date), date_fns_1.startOfHour(new Date()))) {
                            throw new AppError_1.default('past dates are not permitted');
                        }
